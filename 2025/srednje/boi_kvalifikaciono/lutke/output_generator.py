...
END_TEST = 32           # Last test case number (inclusive)
...
print(f"Longest test case time: {max(total_time / success_count, 0):.4f}s" if success_count > 0 else "No successful tests.")
